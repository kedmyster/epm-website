          ...
          <nav role="navigation">
            <ul>
              ...
              <li className="font-title text-epm-gray-700 tracking-wide border-b-1 border-epm-gray-500 mb-3 pb-3">
                <Link href="/careers" onClick={(event) => goToSection(event)}>
                  <a className="block uppercase cursor-pointer relative">
                    <FormattedMessage
                      id="header.menu.careers"
                      defaultMessage="Careers"
                    />
              ...
              <li className="font-title text-epm-gray-700 tracking-wide border-b-1 border-epm-gray-500 mb-3 pb-3">
                <Link href="/media" onClick={(event) => goToSection(event)}>
